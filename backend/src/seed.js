  ...
  try {
    ...
    if (questCheck.length === 0) {
      const quests = [
        ...
        { title: 'PvP Participant',   description: 'Start PvP battles.',                   quest_type: 'weekly', difficulty: 'weekly_easy', category: 'pvp',      action_key: 'pvp_attack',              target_count: 3,  reward_coins: 8, metadata: {}, scale_factors: { t1: 1.0, t2: 1.5, t3: 2.0 } },
        { title: 'Kitchen Student',   description: 'Cook meals.',                         quest_type: 'weekly', difficulty: 'weekly_easy', category: 'cooking',  action_key: 'kitchen_cook',            target_count: 3,  reward_coins: 8, metadata: {}, scale_factors: { t1: 1.0, t2: 1.5, t3: 2.0 } },
        { title: 'Dungeon Explorer',  description: 'Enter adventure dungeons.',           quest_type: 'weekly', difficulty: 'weekly_easy', category: 'dungeon',  action_key: 'dungeon_enter_adventure', target_count: 3,  reward_coins: 8, metadata: {}, scale_factors: { t1: 1.0, t2: 1.5, t3: 2.0 } },
        { title: 'Diligent Farmer',   description: 'Collect resources from farmers.',     quest_type: 'weekly', difficulty: 'weekly_easy', category: 'resource', action_key: 'farmer_collect',          target_count: 5,  reward_coins: 8, metadata: {}, scale_factors: { t1: 1.0, t2: 1.5, t3: 2.0 } },
        // ── Weekly: WEEKLY_MEDIUM pool (pick 1, scale: t1=1.0 t2=1.5 t3=2.5) ─
        { title: 'PvP Victor',        description: 'Win PvP battles.',                     quest_type: 'weekly', difficulty: 'weekly_medium', category: 'pvp',      action_key: 'pvp_win',              target_count: 2,  reward_coins: 12, metadata: {},                           scale_factors: { t1: 1.0, t2: 1.5, t3: 2.5 } },
        { title: 'Harvest Master',    description: 'Win harvest dungeon runs.',            quest_type: 'weekly', difficulty: 'weekly_medium', category: 'dungeon',  action_key: 'dungeon_claim_harvest',target_count: 5,  reward_coins: 12, metadata: {},                           scale_factors: { t1: 1.0, t2: 1.5, t3: 2.5 } },
        { title: 'Animal Caretaker',  description: 'Collect produce from animals.',        quest_type: 'weekly', difficulty: 'weekly_medium', category: 'animal',   action_key: 'animal_collect',       target_count: 5,  reward_coins: 12, metadata: {},                           scale_factors: { t1: 1.0, t2: 1.5, t3: 2.5 } },
        { title: 'Pinecone Baron',    description: 'Collect pinecone from farmers.',       quest_type: 'weekly', difficulty: 'weekly_medium', category: 'resource', action_key: 'farmer_collect',       target_count: 50, reward_coins: 12, metadata: { resourceType: 'pinecone' }, scale_factors: { t1: 1.0, t2: 1.5, t3: 2.5 } },
        { title: 'Head Chef',         description: 'Use prepared meals.',                  quest_type: 'weekly', difficulty: 'weekly_medium', category: 'cooking',  action_key: 'kitchen_use',          target_count: 3,  reward_coins: 12, metadata: {},                           scale_factors: { t1: 1.0, t2: 1.5, t3: 2.5 } },
        // ── Weekly: WEEKLY_HARD pool (pick 2, scale: t1=1.0 t2=2.0 t3=3.0) ───
        { title: 'PvP Champion',        description: 'Win PvP battles.',                     quest_type: 'weekly', difficulty: 'weekly_hard', category: 'pvp',      action_key: 'pvp_win',                 target_count: 5,  reward_coins: 15, metadata: {},                              scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Archer Duelist',      description: 'Win PvP battles with an Archer.',      quest_type: 'weekly', difficulty: 'weekly_hard', category: 'pvp',      action_key: 'pvp_win',                 target_count: 2,  reward_coins: 15, metadata: { championClass: 'Archer'  },  scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Warrior Duelist',     description: 'Win PvP battles with a Warrior.',      quest_type: 'weekly', difficulty: 'weekly_hard', category: 'pvp',      action_key: 'pvp_win',                 target_count: 2,  reward_coins: 15, metadata: { championClass: 'Warrior' },  scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Boss Slayer',         description: 'Defeat a boss stage in Adventure.',    quest_type: 'weekly', difficulty: 'weekly_hard', category: 'dungeon',  action_key: 'dungeon_claim_adventure', target_count: 1,  reward_coins: 15, metadata: { isBoss: true },              scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Three Star Run',      description: 'Get 3 stars in an adventure dungeon.', quest_type: 'weekly', difficulty: 'weekly_hard', category: 'dungeon',  action_key: 'dungeon_claim_adventure', target_count: 1,  reward_coins: 15, metadata: { minStars: 3 },               scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Deep Dungeon',        description: 'Win harvest dungeon runs.',             quest_type: 'weekly', difficulty: 'weekly_hard', category: 'dungeon',  action_key: 'dungeon_claim_harvest',   target_count: 10, reward_coins: 15, metadata: {},                              scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Egg Producer',        description: 'Collect eggs from chickens.',           quest_type: 'weekly', difficulty: 'weekly_hard', category: 'animal',   action_key: 'animal_collect',          target_count: 15, reward_coins: 15, metadata: { resourceType: 'egg'  },      scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Wool Producer',       description: 'Collect wool from sheep.',              quest_type: 'weekly', difficulty: 'weekly_hard', category: 'animal',   action_key: 'animal_collect',          target_count: 15, reward_coins: 15, metadata: { resourceType: 'wool' },      scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
        { title: 'Upgrade Enthusiast',  description: 'Upgrade any farmer or animal.',         quest_type: 'weekly', difficulty: 'weekly_hard', category: 'upgrade',  action_key: 'any_upgrade',             target_count: 3,  reward_coins: 15, metadata: {},                              scale_factors: { t1: 1.0, t2: 2.0, t3: 3.0 } },
      ];
