...
const translations = {
  en: {
    ...
    allFilter: "All",
    cookingNow: "Cooking",
    cookingBack: "← Back to Recipes",
    noRecipesFound: "No recipes found",
    cookBtn: "Cook",
    notEnoughIngredients: "Not enough",
    readyLabel: "READY",
    statAtk: "⚔️ ATK",
    statDef: "🛡️ DEF",
    statHp: "❤️ HP",
    ...
    targetFarmAnimals: "Farmers & Animals",
    targetAll: "All units",
  },
  tr: {
    // App name
    ...
    allFilter: "Tümü",
    cookingNow: "Pişiyor",
    cookingBack: "Tariflere Dön",
    noRecipesFound: "Tarif bulunamadı",
    cookBtn: "Pişir",
    notEnoughIngredients: "Yetersiz",
    readyLabel: "HAZIR",
    statAtk: "⚔️ SAL",
    statDef: "🛡️ SAV",
    statHp: "❤️ HP",
    ...
    targetFarmAnimals: "Çiftçiler & Hayvanlar",
    targetAll: "Tüm birimler",
  },
} as const;
