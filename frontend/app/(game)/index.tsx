        ...
        onDungeon={() => {
          ...
          router.push({
            ...
            params: {
              ...
              championBoostAttack: String(champ?.boost_attack ?? 0),
              championBoostDefense: String(champ?.boost_defense ?? 0),
              championBoostChance: String(champ?.boost_chance ?? 0),
              championGearAttack: String(champ?.gear_attack ?? 0),
              championGearDefense: String(champ?.gear_defense ?? 0),
              championGearChance: String(champ?.gear_chance ?? 0),
              championCurrentHp: String(champ?.current_hp ?? 0),
              championMaxHp: String(champ?.max_hp ?? 0),
              championBoostHp: String(champ?.boost_hp ?? 0),
              championLevel: String(champ?.level ?? 1),
            },
          });
        }}
        claimableRun={
